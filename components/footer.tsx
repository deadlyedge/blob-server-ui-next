    ...
    <Drawer>
      ...
      <DrawerContent className='p-4 flex items-center justify-center bg-zinc-600/80 backdrop-blur-md'>
        ...
        <div className='p-4 max-w-[50rem]'>
          ...
          <br />
          This two project working together for just one goal: Make your VPS
          investment worthy.
          <br />
          As a hobby programer, I learn programing just for fun and buy a VPS
          just for show off, or at least at the beginning. And then I found if I
          want to safe my files for some more show offs, I can&apos;t, I need to
          pay more for some blob services again. So I&apos;m very angry and I
          have to write something to get back my control.
          <br />
        ...
        <div className='px-4 pb-4 text-zinc-300 text-sm max-w-[40rem]'>
          ...
          <br />
          During my coding works, AI did 80% works somehow, I just drink some
          coffee and do minor adjustments. It&apos;s amazing. Time&apos;s
          changed, people can now do only thinking works, and left 80% for AI.
          Pretty cool!
          <DrawerFooter>
            <DrawerClose>Enjoy!</DrawerClose>
          </DrawerFooter>
        </div>
      </DrawerContent>
    </Drawer>
